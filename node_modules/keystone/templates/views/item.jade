				...
				if list.tracking.createdAt
					...
					if (meta_createdAt)
						.item-details-meta-item
							...
							span.item-details-meta-info= moment(meta_createdAt).format('YYYY-MM-DD h:mm:ssa')
				...
				if list.tracking.updatedAt
					...
					if meta_updatedAt && (!meta_createdAt || meta_createdAt.getTime() !== meta_updatedAt.getTime())
						.item-details-meta-item
							...
							span.item-details-meta-info= moment(meta_updatedAt).format('YYYY-MM-DD h:mm:ssa')
					else
